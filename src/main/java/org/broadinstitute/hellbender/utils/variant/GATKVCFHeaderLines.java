...
public class GATKVCFHeaderLines {
    ...
    static {
        ...
        addFormatLine(new VCFFormatHeaderLine(HAPLOTYPE_MIN_WEIGHT, 1, VCFHeaderLineType.String, "Minimum edge weight value of the graph path to support this phasing haplotype"));
